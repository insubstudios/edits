...
public class MyWebServiceLocator extends org.apache.axis.client.Service implements com.davidgassner.example.webservice.MyWebService {
    ...
    private java.lang.String MyWebServiceSoap_address = "http://localhost:49259/MyWebService.asmx";
    ...
    public com.davidgassner.example.webservice.MyWebServiceSoap getMyWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.davidgassner.example.webservice.MyWebServiceSoapStub _stub = new com.davidgassner.example.webservice.MyWebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.davidgassner.example.webservice.MyWebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.davidgassner.example.webservice.MyWebServiceSoapStub _stub = new com.davidgassner.example.webservice.MyWebServiceSoapStub(new java.net.URL(MyWebServiceSoap_address), this);
                _stub.setPortName(getMyWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://davidgassner.com/example/webservice", "MyWebService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://davidgassner.com/example/webservice", "MyWebServiceSoap"));
        }
